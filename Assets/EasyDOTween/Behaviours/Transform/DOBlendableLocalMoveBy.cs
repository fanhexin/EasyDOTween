...
namespace EasyDOTween.Animation.Transform
{
    ...
    [UnityEngine.AddComponentMenu("EasyDOTween/Transform/DOBlendableLocalMoveBy")]
    public class DOBlendableLocalMoveBy : EasyDOTween.Animation<UnityEngine.Transform>
    {
