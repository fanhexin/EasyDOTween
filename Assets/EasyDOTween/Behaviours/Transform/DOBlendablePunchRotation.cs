...
namespace EasyDOTween.Animation.Transform
{
    ...
    [UnityEngine.AddComponentMenu("EasyDOTween/Transform/DOBlendablePunchRotation")]
    public class DOBlendablePunchRotation : EasyDOTween.Animation<UnityEngine.Transform>
    {
